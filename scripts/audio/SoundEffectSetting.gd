...
enum SOUND_EFFECT_TYPE {
	...
	ON_PLAYER_SWORD_BLOCK, # 18
	ON_PLAYER_SWORD_LIGHT_PARRY, # 19
	ON_PLAYER_SWORD_MEDIUM_PARRY, # 20
	ON_PLAYER_SWORD_HEAVY_PARRY, # 21
}
...
@export var sound_effect: AudioStream ## The audio resource to play.
